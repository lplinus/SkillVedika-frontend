    ...
    <section className="py-12 sm:py-16 px-4 sm:px-6 bg-white relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative px-4 sm:px-6 group min-h-[450px]">
          ...
          {/* MODIFICATION HERE: 
              1. Added [&::-webkit-scrollbar]:hidden (Chrome/Safari)
                ...
                >
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <a
                      href={`/blog/${blog.slug}`}
                      aria-label={`Read more about ${blog.title}`}
                      className="bg-[#1e5ba8] text-white px-4 py-2 rounded text-sm mt-auto self-start min-h-[44px] flex items-center hover:opacity-90 transition-opacity"
                    >
                      Read More
                      <span className="sr-only"> about {blog.title}</span>
                    </a>
