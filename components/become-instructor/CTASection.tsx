...
export default function CTASection({ 
  ...
  return (
    ...
    //   </div>
    // </section>
    <section className="relative bg-gradient-to-br from-[#e8efff] via-[#e8fbff] to-[#e8efff] py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 border-t border-blue-100 overflow-hidden">
  ...
  <div className="max-w-4xl mx-auto text-center relative z-10">
    ...
    <div className="flex justify-center">
      <Button
        onClick={scrollToForm}
        size="lg"
        className="group bg-[#002B5B] hover:bg-[#001f42] text-white font-semibold px-8 sm:px-10 py-6 sm:py-7 text-base sm:text-lg transition-all duration-200 min-w-[280px] sm:min-w-[320px]"
      >
        {buttonText}
